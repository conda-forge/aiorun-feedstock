...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiorun-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7910&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiorun-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiorun` can be installed with:

```
conda install aiorun
```

It is possible to list all of the versions of `aiorun` available on your platform with:
